  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-pink-300 via-purple-400 to-indigo-600 text-gray-800 scroll-smooth">
      ...
      <nav className="fixed top-4 left-0 right-0 z-50 flex justify-center">
        <a href="#message-section" className="px-4 py-2 bg-white/30 backdrop-blur-sm text-white rounded-full mx-2 hover:bg-white/50 transition">
          Сообщение
        </a>
        <a href="#ticket-section" className="px-4 py-2 bg-white/30 backdrop-blur-sm text-white rounded-full mx-2 hover:bg-white/50 transition">
          Билет
        </a>
        <a href="#invitation-section" className="px-4 py-2 bg-white/30 backdrop-blur-sm text-white rounded-full mx-2 hover:bg-white/50 transition">
          Приглашение
        </a>
      </nav>
      ...
      <div className="container mx-auto px-4 py-12 max-w-3xl">
        ...
        {/* Билет в кино */}
        <section id="ticket-section" className="scroll-mt-24">
        ...
        {/* Приглашение встретиться */}
        <section id="invitation-section" className="scroll-mt-24">
